...
public class WaystoneConfig {
    ...
    public void reloadLocal(Configuration config) {
        ...
        allowReturnScrolls = config
            .getBoolean("Allow Return Scrolls", "general", true, "If true, return scrolls will be craftable.");
        ...
        allowWarpStone = config
            .getBoolean("Allow Warp Stone", "general", true, "If true, the warp stone will be craftable.");
        ...
        disableParticles = config
            .getBoolean("Disable Particles", "client", false, "If true, activated waystones will not emit particles.");
        ...
        privateWaystones = config
            .getBoolean("Private Waystones", "general", false, "If true, only owners can break their own waystones.");
